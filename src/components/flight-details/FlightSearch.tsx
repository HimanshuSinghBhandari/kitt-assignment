...
const FlightSearch: React.FC = () => {
  ...
  return (
    ...
    { !showResults ? (
      <><h1 className="text-4xl mb-8 text-center" style={{ fontFamily: 'Neue Montreal, sans-serif' }}>
                  Good afternoon, Brian
              </h1><div className="flex flex-col space-y-2 w-full max-w-4xl">
                      ...
                      <div className="flex flex-wrap justify-between items-end gap-4 w-full">
                          <div className="relative flex-grow">
                              <Icon icon={MdMyLocation} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                              <select
                          ...
                          <div className="bg-gray-200 p-2 rounded-full">
                              <Icon icon={TbArrowsDoubleNeSw} className="text-gray-600 transform rotate-45" />
                          </div>
                          ...
                          <div className="flex-grow">
                              <label className="block text-xs text-gray-600 mb-1">Return</label>
                              <input
                                  type="date"
                                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  value={returnDate}
