  ...
  return (
    <div className="fixed inset-y-0 right-0 w-full sm:w-1/2 bg-white shadow-lg z-50 transition-transform duration-300 transform translate-x-0">
      <div className="p-4">
        ...
        {flightDetails[1] && renderFlightProgress(flightDetails[1], returnDate, 'inbound')}
        ...
        <button className="mt-6 px-4 bg-[#003E39] text-white py-3 rounded-lg text-sm items-center">
          Continue to Book
        </button>
      </div>
    </div>
